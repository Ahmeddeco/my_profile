...
import { getAllInstructorsForSelectType } from "@/app/[locale]/server/courses/modules/course.type"
import { addCourseAction } from "@/app/[locale]/server/courses/modules/course.action"
...
export default function AddCourseForm({ allInstructors }: Props) {
	...
	return (
		<Form id={form.id} action={action} onSubmit={form.onSubmit} className="space-y-6">
			...
			<TiptapEditor
				...
				defaultValue={fields.detailsAr.initialValue ?? ""}
			...
			<TiptapEditor
				...
				defaultValue={fields.detailsEn.initialValue ?? ""}
			...
			<div className="grid lg:grid-cols-4 grid-cols-2 gap-6">
				...
				<Field>
					...
					<Input
						...
						defaultValue={fields.discountAmount.initialValue}
					/>
				...
				{/* ------------------------------ Instructors ----------------------------- */}
				<Field>
					<FieldLabel htmlFor={fields.instructorId.name}>Instructors</FieldLabel>
					<Select
						key={fields.instructorId.key}
						name={fields.instructorId.name}
						defaultValue={fields.instructorId.initialValue}
					>
						<SelectTrigger>
							<SelectValue />
						</SelectTrigger>
				...
				<Field>
					...
					<Select key={fields.field.key} name={fields.field.name} defaultValue={fields.field.initialValue}>
						<SelectTrigger>
							<SelectValue />
						</SelectTrigger>
						<SelectContent>
