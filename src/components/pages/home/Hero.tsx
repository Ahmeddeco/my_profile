		...
		<section className=" min-h-[80vh] flex flex-col items-center gap-6 h-auto ">
			...
			<div className="flex flex-wrap-reverse gap-6  w-full items-center justify-center size-auto">
				...
				<div className="flex-1 w-full min-w-xs flex flex-col gap-6 ">
					...
					<h4>{dic.homePage.hero.mainParagraph}</h4>
					<div className="flex flex-col gap-1">
						<h2 className="text-primary">126+</h2>
						<h4>{dic.homePage.hero.clientServed}</h4>
					</div>
				</div>

				{/* -------------------------------- Image ------------------------------- */}
				<div className="flex-2 min-w-xs w-full aspect-square relative bg-radial from-foreground/50 via-primary to-primary  rounded-full ">
				...
				<div className="flex-1 hidden min-w-xs w-full lg:flex flex-col gap-6 ">
					...
					<h2 className="capitalize text-primary">{dic.homePage.hero.starsTitle}</h2>
