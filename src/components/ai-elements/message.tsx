...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
	<div
		className={cn(
			...
			"group-[.is-user]:ms-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-primary group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-primary-foreground ",
...
export const MessageBranchSelector = ({ className, ...props }: MessageBranchSelectorProps) => {
	...
	return (
		<ButtonGroup
			className={cn("[&>*:not(:first-child)]:rounded-s-md [&>*:not(:last-child)]:rounded-e-md", className)}
